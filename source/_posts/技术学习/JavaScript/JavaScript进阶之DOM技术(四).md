...
# 1、[DOM](https://so.csdn.net/so/search?q=DOM&spm=1001.2101.3001.7020)简介
...
`this.classList.toggle('hide')` 添加.hide类名

`this.classList.remove('hide')` 移除.hide类名
